...
RELEASE_NAME = "dxlurlvoidservice-python-dist-" + str(VERSION)
CONFIG_RELEASE_NAME = "dxlurlvoidservice-python-dist-config-" + str(VERSION)
...
subprocess.check_call(["sphinx-apidoc",
                       ...
                       os.path.join(DIST_PY_FILE_LOCATION, "dxlurlvoidservice")])
...
print("\nRemoving dxlurlvoidservice.egg-info\n")
remove_tree(os.path.join(DIST_PY_FILE_LOCATION, "dxlurlvoidservice.egg-info"))
