Basic Host Rescan Example
=========================

This sample updates the report for a specific website (triggers a rescan) by invoking the URLVoid API service via DXL.
...
To run this sample execute the ``sample/basic/basic_host_rescan.py`` script as follows:

    .. parsed-literal::

        python sample/basic/basic_host_rescan.py

The output should appear similar to the following:

    .. code-block:: xml

        Response for URLVoid host rescan:
        <?xml version="1.0" encoding="UTF-8"?><response>
            ...
            <action_result>OK</action_result>    <page_load>5.06</page_load>
        </response>
...
The majority of the sample code is shown below:
    ...
    .. code-block:: python
        ...
        with DxlClient(config) as client:
            ...
            # Invoke 'host rescan' method
            request_topic = "/opendxl-urlvoid/service/urlvapi/host/rescan"
...
After connecting to the DXL fabric, a `request message` is created with a topic that targets the "host rescan" method
